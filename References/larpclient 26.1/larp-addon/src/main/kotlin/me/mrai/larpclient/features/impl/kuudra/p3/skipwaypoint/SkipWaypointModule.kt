...
object SkipWaypointModule : Module(
    ...
    private val waypointX = ComponentSetting("Waypoint X", "0.0")
    private val waypointY = ComponentSetting("Waypoint Y", "80.0")
    private val waypointZ = ComponentSetting("Waypoint Z", "0.0")
    ...
    fun render(context: LevelRenderContext) {
        ...
        val x = waypointX.text.toDoubleOrNull() ?: 0.0
        val y = waypointY.text.toDoubleOrNull() ?: 80.0
        val z = waypointZ.text.toDoubleOrNull() ?: 0.0
